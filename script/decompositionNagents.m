...
% [[file:../../../docs/org/decomposition_methods/secureDMPC.org::*Define the Control loop][Define the Control loop:2]]
    [ coordinator, subsystems, theta, lambdaHist] = coordinator.negotiate(coordinator,subsystems,lambdaHist,theta,K,negotP,rho(a,b,K),Ac,bc,proj);
...
% save(getFileName(dataPath,'dmpc4rooms','.mat',chSetpoint,cheating,secure),'-mat')
