% [[file:../../../docs/org/decomposition_methods/secureDMPC.org::*getLambdas][getLambdas:1]]
function [subsystems, lambdas ] = getLambdas(subsystems,theta,negot,K)
