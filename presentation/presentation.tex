...
{5th International Conference on Control and Fault-Tolerant Systems, 2021
  \begin{minipage}{.3\textwidth}
    \centering
    \includegraphics[width=2cm]{../img/logos/logo_IETR.png}
  \end{minipage}
  \begin{minipage}{.3\textwidth}
    \centering
    \vspace{10pt}
    \includegraphics[width=1.5cm]{../img/qrPresentation.png}
    \href{https://git.io/JEFGW}{https://git.io/JEFGW}
  \end{minipage}
  \begin{minipage}{.3\textwidth}
    \centering
    \vspace{10pt}
    \includegraphics[width=2cm]{../img/logos/supelec.jpeg}
  \end{minipage}
}
...
\begin{minipage}[t]{.5\linewidth}
  ...
  \href{mailto:rafael-accacio.nogueira@centralesupelec.fr?subject=SysTol'21 Presentation}{rafael-accacio.nogueira@centralesupelec.fr}
    ...
    \includegraphics[width=2cm]{../img/qrContact.png}
\end{minipage}
\end{frame}
